...
// Nodes where name is Miraouy Outman //
MATCH (player:PLAYER)
WHERE player.name = "Miraouy Outman"
RETURN player

// Nodes where name is Miraouy Outman //
MATCH (player:PLAYER {name: "Miraouy Outman"})
RETURN player

// Nodes where name is not Miraouy Outman
MATCH (player:PLAYER)
WHERE player.name <> "Miraouy Outman"
RETURN player
...
MATCH (lebron:PLAYER {name: "Miraouy Outman"}) - [:TEAMMATES] -> (teammate:PLAYER)
